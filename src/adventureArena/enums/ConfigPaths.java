...
public class ConfigPaths {
	...
	public static final String	foodLevel				= "foodLevel";
	public static final String	bedSpawnLocationX		= "bedSpawnLocation.x";
	public static final String	bedSpawnLocationY		= "bedSpawnLocation.y";
	public static final String	bedSpawnLocationZ		= "bedSpawnLocation.z";
	public static final String	bag						= "bag";
	public static final String	armor					= "armor";
	public static final String	activePotionEffects		= "activePotionEffects";
	...
	public static final String	miniGameHubWorldName	= "miniGameHubWorldName";
